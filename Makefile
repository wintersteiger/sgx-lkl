...
${THIRD_PARTY_LIB_CRYPTSETUP} ${THIRD_PARTY_LIB_POPT} ${THIRD_PARTY_LIB_DEVICE_MAPPER} ${THIRD_PARTY_LIB_EXT2FS} ${THIRD_PARTY_LIB_UUID} ${THIRD_PARTY_LIB_JSON} ${THIRD_PARTY_LIB_CURL} ${OE_STUBS} ${THIRD_PARTY_LIB_BFD}: ${LKL_BUILD}/include
	+${MAKE} -C ${SGXLKL_ROOT}/third_party $@
...
sgx-lkl: ${THIRD_PARTY_LIB_CRYPTSETUP} ${THIRD_PARTY_LIB_EXT2FS} ${THIRD_PARTY_LIB_CURL} ${THIRD_PARTY_LIB_BFD}
	make -C src all
